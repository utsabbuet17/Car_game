...
yellow_strip=pygame.image.load("Images/yellow strip.jpg")
strip=pygame.image.load("Images/strip.jpg")
intro_background=pygame.image.load("Images/background3.jpg")
instruction_background=pygame.image.load("Images/background4.jpg")
car_width=56
pause=False
...
def intro_loop():
    ...
    while intro:
        ...
        largetext=pygame.font.Font("C:\Windows\Fonts\Times.ttf",80)
        TextSurf,TextRect=text_objects("CAR CRUSHED",largetext)
        TextRect.center=(400,100)
        gamedisplays.blit(TextSurf,TextRect)
        button("START",700,520,100,50,green,bright_green,"play")
        button("QUIT",0,520,100,50,red,bright_red,"quit")
